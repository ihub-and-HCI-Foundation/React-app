...
import { fetchSensorData } from "./api/SensorDataService";
...
function App() {
  ...
  const fetchComfortZoneData = async () => {
    try {
        ...
        <>
          <Grid item xs={12} md={todayWeather ? 6 : 12}>
            <TodayWeather
              ...
              dashboardType="weatherDashboard"
            />
          </Grid>
  ...
  const renderComfortZoneDashboard = () => {
    if (sensorData && todayForecast && weekForecast) {
      return (
        <>
          <Grid item xs={12} md={6}>
            <TodayWeather
